...
router.get('/', function(req, res, next) {
    ...
    db.open(connectionString, function (err) {
        ...
        var sql = "SELECT BeginningBalance, DebitAmount, CreditAmount, FiscalYear, FiscalPeriod FROM GL_PeriodPostingHistory INNER JOIN GL_Account ON GL_PeriodPostingHistory.AccountKey = GL_Account.AccountKey Where GL_Account.Account ='5010-05-0000' AND  FiscalYear = 2016";
        ...
        db.query(sql, function (err, rows, moreResultSets) {
           ...
           break;
            ...
            //res.render('index', {title: 'Scrap Dashboard'});
            res.render('index', {title: 'Scrap Dashboard', TubesData: JSON.stringify(TempArray)});
...
router.get('/test', function(req, res, next) {
    ...
    db.open(connectionString, function (err) {
        ...
        db.query(sql, function (err, rows, moreResultSets) {
            ...
            //res.render('test', {title: 'Scrap Dashboard'});
            res.render('test', {title: 'Scrap Dashboard', TubesData: JSON.stringify(TempArray)});
            //var results = rows.toString().replace('{rows}', JSON.stringify(TestArray));
            //console.log(rows.toString().replace('{rows}', JSON.stringify(TestArray)));
            //res.write(results);
            //res.end();
